...
A token is used for the server to know that the person trying to access a protected page is allowed to access it.

- [ ] What steps can you take in your web apps to keep your data secure?
There are numerous ways to help secure data in a web application, but the most common for frontend is through authentication.

- [ ] Describe how web servers work.
Web servers take the requests from a user's computer and 'serves' the correct files that form a web page or application.

- [ ] Which HTTP methods can be mapped to the CRUD acronym that we use when interfacing with APIs/Servers.
PUT requests are the "U" in CRUD, which stands for update. DELETE requests are the "D" in CRUD which stands for delete.
